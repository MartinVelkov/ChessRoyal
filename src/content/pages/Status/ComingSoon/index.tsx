      ...
      <MainContent>
        <Container maxWidth="md">
          <Box textAlign="center" mb={3}>
            <Container maxWidth="xs">
              ...
              <Typography
                ...
                sx={{ mb: 4 }}
              >
                Работим по внедряването на последните функции преди стартиране!
              </Typography>
            </Container>
            <img
              alt="Coming Soon"
          ...
          <Box display="flex" justifyContent="center">
            {timerComponents.length ? timerComponents : <>Времето свърши?</>}
          </Box>
          ...
          <Container maxWidth="sm">
            <Box sx={{ textAlign: 'center', p: 4 }}>
              <FormControl variant="outlined" fullWidth>
                ...
                />
                <FormHelperText>
                 Ние ще ви изпратим имейл когато сме готови!
                </FormHelperText>
              </FormControl>
              <Divider sx={{ my: 4 }} />
